...
import { Printer, ChevronLeft, Trash2, Edit3, CheckCircle2 } from 'lucide-react';
                ...
                <div className="flex justify-between items-start mb-6">
                    ...
                    <div className="flex gap-2.5">
                        <button 
                            ...
                            className="px-3.5 py-2 bg-slate-900 text-gold rounded-lg font-black text-[10px] uppercase tracking-widest hover:bg-primary hover:text-white transition-all flex items-center gap-2 shadow-sm"
                        >
                            <Printer size={14} />
                            Reprint Bill
                        </button>
